...
class Controller extends GetxController {
  ...
  void fifhting() {
    rotate.value = 3.14;
    Future.delayed(const Duration(milliseconds: 500), () {
      if (yourCard.value.name == "king" && enemyCard.value != "slave") {
        debugPrint("you win");
      } else if (yourCard.value.name == "slave" && enemyCard.value == "king") {
        debugPrint("you win");
      } else if (yourCard.value.name == "soldier" &&
          enemyCard.value == "slave") {
        debugPrint("you win");
      } else if (yourCard.value.name == enemyCard.value) {
        debugPrint("you Drou");
      } else {
