...
class RoomStyle extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.lineTo(6, size.height * 0.4996186);
    path_0.lineTo(size.width * 0.1, size.height * 0.9889000);
    path_0.lineTo(size.width * 0.9, size.height * 0.9927000);
    path_0.lineTo(size.width * 0.9975000, size.height * 0.5196031);
    path_0.lineTo(size.width * 0.9, size.height * 0.0022000);
...
class TextfileStyle extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    Paint paintFill0 = Paint()
      ..color = AppColor.primary
    ...
    Path path_0 = Path();
    path_0.moveTo(size.width * 0.0977000, size.height * 0.0003000);
    path_0.lineTo(size.width * 0.02, size.height * 0.4996186);
    path_0.lineTo(size.width * 0.1009750, size.height * 0.9889000);
    path_0.lineTo(size.width * 0.93, size.height * 0.9927000);
    path_0.lineTo(size.width * 0.9975000, size.height * 0.5196031);
    path_0.lineTo(size.width * 0.93, size.height * 0.0022000);
    path_0.lineTo(size.width * 0.0977000, size.height * 0.0003000);
    path_0.close();
